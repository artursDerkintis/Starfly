...
class SFTextView: UIView {
	...
	func setup() {
		...
		textFieldHolder?.layer.backgroundColor = UIColor.whiteColor().colorWithAlphaComponent(0.01).CGColor
	...
	func textFieldStart() {
		...
		basicAnim0.fromValue = currentColor!.colorWithAlphaComponent(0.0001).CGColor
		basicAnim0.toValue = currentColor!.CGColor
		basicAnim0.duration = 0.01
		basicAnim0.fillMode = kCAFillModeForwards
		basicAnim0.removedOnCompletion = false
		textFieldHolder?.layer.addAnimation(basicAnim0, forKey: "shadow")
	...
	func textFieldEnd() {
		hideCompletions()
		let basicAnim0 = CABasicAnimation(keyPath: "backgroundColor")
		basicAnim0.fromValue = currentColor!.CGColor
		basicAnim0.toValue = currentColor!.colorWithAlphaComponent(0.001).CGColor
		basicAnim0.duration = 0.01
		basicAnim0.fillMode = kCAFillModeForwards
		basicAnim0.removedOnCompletion = false
		textFieldHolder?.layer.addAnimation(basicAnim0, forKey: "shadow24")
		let basicAnim = CABasicAnimation(keyPath: "shadowRadius")
