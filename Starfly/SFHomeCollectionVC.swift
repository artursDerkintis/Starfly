...
//		collection?.registerClass(SFFavoritesCell.self, forCellWithReuseIdentifier: "MiNiI")
...
//			if onoroff {
//				for cell in self.collection?.visibleCells() as! [SFFavoritesCell] {
...
//		let imagePlace = object.bigImage
//		let cely = self.collection!.cellForItemAtIndexPath(indexPath) as? SFFavoritesCell
//		print(cely)
//		if cely != nil {
...
//		let cell = collectionView.dequeueReusableCellWithReuseIdentifier("MiNiI", forIndexPath: indexPath) as! SFFavoritesCell
//
//		let object = fetchedResultController!.objectAtIndexPath(indexPath) as! HomeHit
